...
@Composable
fun PantallaRespaldos(viewModel: RespaldosViewModel, volver: () -> Unit) {
    ...
    Scaffold(containerColor = FondoPrincipal, topBar = { Column {
        ...
        Column(Modifier.fillMaxSize().padding(padding).padding(16.dp)) {
            ...
            Text("Incluye datos, PDFs de cotizaciones y evidencias fotográficas. El archivo contiene información privada.", color = TextoSecundario, modifier = Modifier.padding(top = 6.dp))
