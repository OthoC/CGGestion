...
data class HojaCampoEntity(
 ...
 val trabajosRealizados:String="",val observaciones:String="",val horaInicioPruebas:String="",val horaFinPruebas:String="",val nombreClienteResponsable:String="",val estadoFirma:String="PENDIENTE",val firmaClienteRuta:String?=null
)
